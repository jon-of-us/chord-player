...
var require_lib = __commonJS({
  "node_modules/audio-loader/lib/index.js"(exports, module) {
    ...
    function load(ac, source, options, defVal) {
      var loader = (
        // Basic audio loading
        isArrayBuffer(source) ? loadArrayBuffer : isAudioFileName(source) ? loadAudioFile : isPromise(source) ? loadPromise : isArray(source) ? loadArrayData : isObject(source) ? loadObjectData : isJsonFileName(source) ? loadJsonFile : isBase64Audio(source) ? loadBase64Audio : isJsFileName(source) ? loadMidiJSFile : null
      );
      var opts = options || {};
...
var require_player = __commonJS({
  "node_modules/sample-player/lib/player.js"(exports, module) {
    ...
    function envelope(ac, options, opts) {
      ...
      env.value.value = isNum2(options.gain) ? options.gain : isNum2(opts.gain) ? opts.gain : 1;
      return env;
    }
...
var require_note_parser = __commonJS({
  "node_modules/sample-player/node_modules/note-parser/index.js"(exports, module) {
    "use strict";
    var REGEX2 = /^([a-gA-G])(#{1,}|b{1,}|x{1,}|)(-?\d*)\s*(.*)\s*$/;
    function regex2() {
      return REGEX2;
    }
    var SEMITONES2 = [0, 2, 4, 5, 7, 9, 11];
    function parse2(str, isTonic, tuning) {
      ...
      p.chroma = SEMITONES2[p.step] + p.alt;
      if (m[3]) {
        p.oct = +m[3];
    ...
    var parser = { parse: parse2, regex: regex2, midiToFreq: midiToFreq2 };
...
var require_lib2 = __commonJS({
  "node_modules/sample-player/lib/index.js"(exports, module) {
    ...
    function SamplePlayer(ac, source, options) {
      return midi2(scheduler(notes(events(player(ac, source, options)))));
    }
    if (typeof module === "object" && module.exports)
      module.exports = SamplePlayer;
    if (typeof window !== "undefined")
...
var note_parser_exports = {};
__export(note_parser_exports, {
  acc: () => acc,
  alt: () => alt,
  build: () => build,
  chroma: () => chroma,
...
var require_legacy = __commonJS({
  "node_modules/soundfont-player/lib/legacy.js"(exports, module) {
    "use strict";
    var parser = (init_note_parser(), __toCommonJS(note_parser_exports));
    ...
    function oscillatorPlayer(ctx, defaultOptions) {
      ...
      return function(note, time, duration, options) {
        ...
        var midi2 = note > 0 && note < 129 ? +note : parser.midi(note);
...
//# sourceMappingURL=soundfont-player.js.map
